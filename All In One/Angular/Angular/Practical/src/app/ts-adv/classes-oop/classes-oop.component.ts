...
@Component({
  ...
  imports: [],
  templateUrl: './classes-oop.component.html',
  styleUrl: './classes-oop.component.css'
})
export class ClassesOopComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    class User {
      ...
      greet(): void {
        console.log(`Hello Team ${this.name}`);
      }
    }
